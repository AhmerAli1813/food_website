...
if(isset($_POST["action"])){
      ...
      if($_POST["action"]  == "get"){
          ...
          $form .= ' <form  id="productsFormEdit" method="post">
          ...
          <select class="form-select form-select-lg" name="pCat_id" style="padding-top: 0.2rem !important;padding-bottom: 0.2rem !important;" >';
          ...
          <select class="form-select form-select-lg" name="pScat_id" style="padding-top: 0.2rem !important;padding-bottom: 0.2rem !important;" >';
