                ...
                <div class="row">
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs me-2"></i> <span class="text-600 text-90">ID:</span> #111-222</div>

                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs me-2"></i> <span class="text-600 text-90">Issue Date:</span> Oct 12, 2019</div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                    ...
                    <div>
                        ...
                        <a href="#" class="btn btn-info btn-bold px-4 float-end mt-3 mt-lg-0">Pay Now</a>
                    </div>
                </div>
            </div>
        </div>
